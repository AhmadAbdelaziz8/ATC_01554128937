...
const venueTypes = [
  "Convention Center", "Hotel", "Conference Hall", "Theater", "Stadium",
  "Gallery", "Museum", "Park", "Community Center", "University Campus"
];
...
const eventNames = {
  "Workshops": ["Design Workshop", "Pottery Workshop", "Creative Writing Workshop", "Photography Workshop", "Coding Bootcamp"],
  "Networking": ["Business Mixer", "Industry Meetup", "Professional Networking", "Startup Weekend", "Tech Networking Event"],
  "Educational": ["Science Fair", "History Lecture", "Educational Seminar", "Learning Symposium", "Academic Conference"],
  "Holidays": ["Christmas Celebration", "New Year's Party", "Holiday Festival", "Easter Event", "Halloween Party"],
  "Hobbies": ["Book Club Meeting", "Gardening Workshop", "Chess Tournament", "Painting Class", "Craft Workshop"],
  "Business": ["Business Conference", "Marketing Seminar", "Entrepreneurship Summit", "Investment Forum", "Corporate Retreat"],
  "Food & Drink": ["Food Festival", "Wine Tasting", "Cooking Class", "Beer Festival", "Culinary Tour"],
  "Music": ["Live Concert", "Jazz Night", "Music Festival", "Orchestra Performance", "Band Showcase"],
  "Sports": ["Marathon", "Basketball Tournament", "Soccer Match", "Tennis Open", "Volleyball Competition"],
  "Art & Culture": ["Art Exhibition", "Cultural Festival", "Museum Tour", "Theater Performance", "Dance Recital"]
};
...
function generateMockEvents(count = 30) {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    const eventName = eventNameOptions[Math.floor(Math.random() * eventNameOptions.length)];
